...
export const DropdownWithTitle: React.FC<DropdownWithTitleProps> = ({ className }) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* 🎯 PRESERVAÇÃO: Título de seção + ADAPTAÇÃO: Cores */}
                <li className={twMerge(
                    // PRESERVAÇÃO: Classes originais
                    'dropdown-title px-4 py-2 text-sm font-semibold',
                    // ADAPTAÇÃO: Tema
                ...
                <li>
                    <a
                        className={twMerge(
                            ...
                            'dropdown-item block px-4 py-2 text-sm transition-colors',
                ...
                <hr className={twMerge(
                    // PRESERVAÇÃO: Classes originais de layout
                    'my-2 -mx-2 border-t',
                    // ADAPTAÇÃO: Cor baseada no tema
                    isDark ? 'border-gray-600/25' : 'border-gray-300/25'
                )} />

                {/* 🎯 PRESERVAÇÃO: Segundo título de seção + ADAPTAÇÃO: Cores */}
                <li className={twMerge(
                    'dropdown-title px-4 py-2 text-sm font-semibold',
                    isDark ? 'text-gray-300' : 'text-gray-700'
                )}>
                ...
                {/* 🎯 PRESERVAÇÃO: Item final + ADAPTAÇÃO: Tema */}
                <li>
                    <a
                        className={twMerge(
                            'dropdown-item block px-4 py-2 text-sm transition-colors',
