        ...
        <div className="px-6 py-4">
          ...
          {type === 'answer72h' && (
            <div className="space-y-3">
              ...
              <input type="text" placeholder='Situação (ex.: "seu feedback")' value={hook.situacao} onChange={(e) => hook.setSituacao(e.target.value)} className="w-full rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-transparent px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 focus:outline-none" />
              <textarea placeholder="Escreva uma mensagem personalizada..." value={hook.message72h} onChange={(e) => hook.setMessage72h(e.target.value)} rows={3} className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-transparent px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 focus:outline-none" />
              <div className="flex justify-end">
                <ActionButton
          ...
          {type === 'classification' && (
            <div className="space-y-3">
              ...
              <div>
                ...
                <select value={hook.classification} onChange={(e) => { hook.setClassification(e.target.value); hook.setSubClassification('') }} className="w-full rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-transparent px-3 py-2 text-sm text-gray-900 dark:text-white">
              ...
              {hook.classification && (
                <div>
                  ...
                  {hook.subclassificationsQuery.isLoading ? <Loader2 className="animate-spin text-gray-400" size={20} /> : (
                    <select value={hook.subClassification} onChange={(e) => hook.setSubClassification(e.target.value)} className="w-full rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-transparent px-3 py-2 text-sm text-gray-900 dark:text-white">
                      <option value="">Selecione</option>
