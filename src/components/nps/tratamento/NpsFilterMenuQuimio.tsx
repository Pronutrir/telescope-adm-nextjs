...
import {
  ...
  MapPin, UserRound, Shield, MessageSquare,
} from 'lucide-react'
...
const SECTION_ICONS: Record<IOptionsFilterQuimioQuests, React.ElementType> = {
  unidade: MapPin,
  profissional: UserRound,
  convenio: Shield,
}

const SECTION_COLORS: Record<IOptionsFilterQuimioQuests, { color: string; bg: string }> = {
            ...
            <div className="px-3 py-2.5 mb-1 rounded-xl border border-gray-100 dark:border-gray-700/40">
              <label className="flex cursor-pointer items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Somente com NPS preenchido</span>
                </div>
                <span className={cn(
