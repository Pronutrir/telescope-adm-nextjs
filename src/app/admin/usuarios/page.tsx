        ...
        <div className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <p className={twMerge(
                                'text-sm px-3 py-2 rounded-lg font-mono border',
                                isDark
                                    ? 'bg-gray-900/50 text-gray-200 border-gray-600 ring-1 ring-gray-700'
                        ...
                        <div>
                            ...
                            <p className={twMerge(
                                'text-sm px-3 py-2 rounded-lg flex items-center gap-2 border',
                                isDark
                                    ? 'bg-gray-900/50 text-gray-200 border-gray-600 ring-1 ring-gray-700'
                                    : 'bg-gray-100 text-gray-700 border-gray-300'
                            )}>
            ...
            <div>
                ...
                <div className={twMerge(
                    ...
                    isDark
                        ? 'bg-gray-900/50 border-gray-600 ring-1 ring-gray-700'
