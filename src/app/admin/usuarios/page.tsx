...
const TabContent = ({ activeTab, searchTerm, setSearchTerm, isLoading, viewMode, setViewMode, usuarios, loadingUsuarios, errorUsuarios }: {
    activeTab: string,
    searchTerm: string,
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-4 mt-1">
                                                ...
                                                <span className={twMerge(
                                                    ...
                                                    {user.department} • Último acesso: {user.lastLogin}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
