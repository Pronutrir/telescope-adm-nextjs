                    ...
                    <div className="flex flex-col h-full space-y-4">
                        ...
                        <div className="flex flex-col gap-3 shrink-0">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                {/* Toggle visualização */}
                                <div className={twMerge(
                                    'flex border rounded-lg overflow-hidden shrink-0',
                            ...
                            {loadingUsuarios ? (
                                ...
                                <div className={twMerge(
                                    ...
                                    {usuariosFiltrados.map((user: any) => (
                                        viewMode === 'list' ? (
                                            // List View (código existente do TabContent)
                                            <div
                                                key={user.idUsuario}
                                                className={twMerge(
                                            ...
                                            >
                                                {/* Conteúdo do card em list view - será inserido */}
                                            ...
                                            // Grid View (código existente do TabContent)
                                            <div
                                                key={user.idUsuario}
                                                className={twMerge(
