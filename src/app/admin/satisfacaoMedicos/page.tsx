...
export default function SatisfacaoMedicosPage() {
    return (
        <div className="space-y-8">
            <div className="text-center">
                ...
                <p className="text-gray-600 mt-3 text-lg">
                    Pesquisas de satisfação dos médicos
                </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-8">
                ...
                <p className="text-gray-600">Aqui ficará os dados das pesquisas de satisfação dos médicos.</p>
            </div>
        </div>
    )
}
